<x-admin.wrapper>
    ...
    <div class="container drop-shadow-lg mt-2 mx-auto w-full md:w-4/5 bg-[#f5f5f5] rounded-lg p-2">
        <form action="{{route('admin.edit.speciality' , ['speciality' => $speciality->id])}}" class="mx-auto" method="post">
            @csrf
            ...
            <div class="inputs">
                <div class="inpt my-4 w-full">
                    <div class="hi m-auto w-4/5 relative">
                        ...
                        <input value="{{ $speciality->university}}" id="university" placeholder="university..." type="text" name="university"
                ...
                <div class="inpt my-4 w-full">
                    <div class="hi m-auto w-4/5 relative">
                        ...
                        <input value="{{ $speciality->name}}" id="name" placeholder="speciality name..." type="text" name="name"
                               class="border-b border-l bg-transparent focus:bg-white border-sky-300 focus:border focus:border-sky-500 duration-150 ease-in-out outline-none h-10 px-4 w-full">
                    </div>
                    @error('name')
                    <div class="text-center text-red-400 font-medium">
                ...
                <div class="inpt my-4 w-full text-center">
                    <select class="m-auto w-4/5 border-b border-l bg-transparent focus:bg-white border-sky-300 focus:border focus:border-sky-500 duration-150 ease-in-out outline-none h-10 px-4 " name="module_name" id="module_name">
                        ...
                        @foreach($modules as $module)
                            <option value="{{$module->name}}"  @selected($speciality->module->name == $module->name) >{{$module->name}}</option>
                        @endforeach
                    </select>
                    @error('module_name')
                    <div class="text-center text-red-400 font-medium">
                ...
                <div class="inpt my-4 w-full">
                    <div class="hi m-auto w-4/5 relative">
                        ...
                        <input value="{{ $speciality->places}}" id="places" placeholder="places ..." type="number" min="0" name="places"
                               class="border-b border-l bg-transparent focus:bg-white border-sky-300 focus:border focus:border-sky-500 duration-150 ease-in-out outline-none h-10 px-4 w-full">
                    </div>
                    @error('places')
                    <div class="text-center text-red-400 font-medium">
                ...
                <div class="inpt my-4 w-full">
                    <div class="hi m-auto w-4/5 relative flex items-center">
                        <input @checked( $speciality->only_bac ) id="places" class="w-4 h-4" type="checkbox" name="bac_only">
